        ...
        <div className="min-h-screen bg-background flex items-center justify-center px-4">
            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
                    ...
                    {verificationSent ? (
                        <div className="text-center py-6 bg-accent/5 rounded-2xl border border-accent/20">
                            <CheckCircle className="w-12 h-12 text-accent mx-auto mb-4" />
                            <h2 className="text-xl font-bold text-foreground mb-2">Check your email</h2>
                            <p className="text-sm text-foreground/70 mb-4 px-4">
                                We've sent a magic link to <span className="font-semibold">{email}</span>. Click the link to instantly access your analysis.
                            </p>
                            <button
                        ...
                        <>
                            ...
                            <p className="text-xs text-center text-foreground/40 mt-6">
                                Start your free analysis in seconds.
                            </p>
                        </>
                    )}
