...
export default function AlternativePostPage() {
        ...
        return (
            <div className="min-h-screen bg-[#f8f9fe] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button onClick={() => router.push('/alternatives')} className="text-accent font-semibold hover:underline">
    ...
    return (
        <>
            <Head>
                <title>{blog.title} | SEOzapp</title>
                <meta name="description" content={blog.excerpt} />
                <meta name="robots" content="index, follow" />
                <link rel="canonical" href={`https://www.seozapp.com/alternatives/${blog.slug}`} />
                <meta property="og:title" content={`${blog.title} | SEOzapp`} />
                <meta property="og:description" content={blog.excerpt} />
                <meta property="og:url" content={`https://www.seozapp.com/alternatives/${blog.slug}`} />
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            mainEntityOfPage: {
                                '@type': 'WebPage',
                                '@id': `https://www.seozapp.com/alternatives/${blog.slug}`,
                            },
                        }),
                    }}
                />
            ...
            <div className="min-h-screen bg-[#f8f9fe]">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white sticky top-0 z-40">
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">All Alternatives</span>
                    </button>
